...
__schedule_change_urls = [
    ...
    url(r'^change_schedules$', views.change_events, name='change_schedules'),
...
__schedule_delete_urls = [
    ...
    url(r'^delete_schedule$', views.delete_event, name='delete_schedule'),
]
...
schedule_urls = __schedule_add_urls + __schedule_change_urls + __schedule_delete_urls + [
    ...
    url('^search_schedule$', views.table_schedule, name='change_schedule_table'),
